...
- **Keep it Simple**: This is a simple app with a few screens and typically less than 10,000 flights, 100 sites and 10 wings. Choose simple, proven solutions over complex architectures
...
- **App Testing**: Test app changes by:
  - Adding logging that helps with understanding app usage, performance and diagnosing errors.
...
- **State Management**: Provider (partial implementation - some ViewModels use ChangeNotifier)
...
- WHen you see the erro "stuck in ring seqno" error, kill and restart the app